...
export function BalanceSummaryCard() {
  return (
    <Card className="relative flex h-full w-full flex-col overflow-clip px-0 pb-0">
      <CardHeader className="flex-shrink-0 flex-row items-center justify-start gap-4 pt-6">
        <h3 className="text-3xl font-medium">$60,000</h3>
      </CardHeader>
      <CardContent className="flex h-full flex-col justify-between gap-8 px-0 pb-0">
        <div>
          ...
          <div className="mt-2 px-6 text-sm text-muted-foreground">
